...
type PembayaranDto struct {
	...
	QrisSection         *PembayaranQrisSectionDto `json:"qris_section,omitempty"`
	PaymentOptionsTitle *string                   `json:"payment_options_title,omitempty"`
	PaymentOptions      []PembayaranOptionDto     `json:"payment_options,omitempty"`
	PrintButtonLabel    *string                   `json:"print_button_label,omitempty"`
}

type PembayaranStatusCardDto struct {
	Title     *string `json:"title,omitempty"`
	Message   *string `json:"message,omitempty"`
	IsSuccess *bool   `json:"is_success,omitempty"`
}

type PembayaranQrisSectionDto struct {
	Title            *string   `json:"title,omitempty"`
	QrContent        *IsiQrDto `json:"qr_content,omitempty"`
...
type PembayaranOptionDto struct {
