...
type RiwayatParkirDto struct {
	Summary ParkingSummaryDto      `json:"summary"`
	Items   []RiwayatParkirItemDto `json:"items"`
}

// ParkingSummary merepresentasikan data statistik di Top Metric Card
type ParkingSummaryDto struct {
...
type RiwayatParkirItemDto struct {
	ID           string     `json:"id"`
