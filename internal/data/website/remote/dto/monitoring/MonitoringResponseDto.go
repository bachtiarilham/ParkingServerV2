...
type MonitoringResponseDto struct {
	Parlok    *[]ParlokItemDto    `json:"parlok"`
	Transaksi *[]TransaksiItemDto `json:"transaksi"`
}

type ParlokItemDto struct {
