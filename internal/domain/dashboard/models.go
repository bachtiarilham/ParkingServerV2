...
type Repository interface {
	FindAdminByIdentity(ctx context.Context, identity string) (*AuthRecord, error)
	FindAdminByID(ctx context.Context, userID int64) (*AuthRecord, error)
	GetDashboardOverview(ctx context.Context) (DashboardOverview, error)
	GetMonitoringOverview(ctx context.Context) (MonitoringOverview, error)
	GetOfficerOverview(ctx context.Context) (OfficerOverview, error)
	GetTransactionsOverview(ctx context.Context) (TransactionsOverview, error)
	GetSettingsOverview(ctx context.Context) (SettingsOverview, error)
	UpdateSettingsOverview(ctx context.Context, adminUserID int64, req UpdateSettingsOverviewRequest) (SettingsOverview, error)
	UpdateLocationSettings(ctx context.Context, adminUserID int64, locationID string, req UpdateLocationSettingsRequest) (ParkingLocation, error)
	SaveLocationShiftTemplates(ctx context.Context, adminUserID int64, locationID string, shiftTemplates []ParkingShiftTemplate) (ParkingLocation, error)
	UpdateOfficerStatus(ctx context.Context, adminUserID int64, officerID string, status string) (ParkingOfficerOption, error)
	ApplyOfficerMutation(ctx context.Context, adminUserID int64, req ApplyOfficerMutationRequest) (ParkingOfficerOption, error)
	CreateDisputeCase(ctx context.Context, adminUserID int64, req CreateDisputeCaseRequest) (DisputeCaseSummary, error)
	UpdateDisputeCaseStatus(ctx context.Context, adminUserID int64, disputeID string, req UpdateDisputeCaseStatusRequest) (DisputeCaseSummary, error)
	CreateRefundTransaction(ctx context.Context, adminUserID int64, req CreateRefundTransactionRequest) (RefundTransactionSummary, error)
	UpdateRefundTransactionStatus(ctx context.Context, adminUserID int64, refundID string, req UpdateRefundStatusRequest) (RefundTransactionSummary, error)
	CreateClosingBatch(ctx context.Context, adminUserID int64, req CreateClosingBatchRequest) (ClosingBatchSummary, error)
	UpdateClosingBatchStatus(ctx context.Context, adminUserID int64, closingID string, req UpdateClosingStatusRequest) (ClosingBatchSummary, error)
}
